...
var tagAndLengthData = []tagAndLengthTest{
	...
	// 长度为0 {[]byte{0xa0, 0x82, 0x00, 0xff}, false, tagAndLength{}},
	// Lengths up to the maximum size of an int should work.
	{[]byte{0xa0, 0x84, 0x7f, 0xff, 0xff, 0xff}, true, tagAndLength{2, 0, 0x7fffffff, true}},
	// Lengths that would overflow an int should be rejected.
	{[]byte{0xa0, 0x84, 0x80, 0x00, 0x00, 0x00}, false, tagAndLength{}},
	// Long length form may not be used for lengths that fit in short form.
	// 长度不正确 {[]byte{0xa0, 0x81, 0x7f}, false, tagAndLength{}},
	// Tag numbers which would overflow int32 are rejected. (The value below is 2^31.)
	// 长度不正确 {[]byte{0x1f, 0x88, 0x80, 0x80, 0x80, 0x00, 0x00}, false, tagAndLength{}},
}
...
func TestUnmarshalInt(t *testing.T) {
	data := []byte{}

	var val RawValue
	_, err := Unmarshal(data, &val)
	if err != nil {
		t.Error("Unmarshal failed at index", err)
	}
	// if !reflect.DeepEqual(val, test.out) {
	// 	t.Errorf("#%d:\nhave %#v\nwant %#v", i, val, test.out)
	// }
